...
const App = window.go?.internal?.app?.App;
...
function initSettings() {
    ...
    if (App.GetConfig) {
        App.GetConfig().then(cfg => {
            if (cfg) {
                ...
                document.getElementById('setting-clockify-ws').value = cfg.ClockifyWorkspaceID || '';
    ...
    document.getElementById('settings-api-form').addEventListener('submit', async (e) => {
        ...
        const config = {
            ...
            ClockifyWorkspaceID: document.getElementById('setting-clockify-ws').value.trim(),
        ...
        try {
            if (App.SaveConfig) {
                ...
                // Could refresh connections here
            } else {
